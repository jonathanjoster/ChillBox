...
function showMore() {
  var showedCount = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.border').data('showed');
  ...
  jquery__WEBPACK_IMPORTED_MODULE_0___default.a.post("/?showed=".concat(showedCount), function (musics) {
    ...
    try {
      for (_iterator.s(); !(_step = _iterator.n()).done;) {
        ...
        jquery__WEBPACK_IMPORTED_MODULE_0___default()('.list').append(createNewMusic(m));
      }
    } catch (err) {
      _iterator.e(err);
    } finally {
...
jquery__WEBPACK_IMPORTED_MODULE_0___default()(document).scroll(function () {
  var target = jquery__WEBPACK_IMPORTED_MODULE_0___default()('.border').offset().top;
  var scroll = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).scrollTop();
  var height = jquery__WEBPACK_IMPORTED_MODULE_0___default()(window).height(); // in accordance with scroll, show more contents
